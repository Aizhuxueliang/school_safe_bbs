 ...
 <body>
  ...
  <table class="layui-table">
    ...
    <c:forEach var="list"  items="${list}">
      <tr>
        <td><a href="<%=basePath_top %>news/web_list.do?newstypeId=${list.newstype.id}">${list.newstype.type }</a></td>
    ...
    $(function(){ 
    	$(".del").click(function(){
		    ...
		    $.messager.confirm("系统提示", "您确认要删除这条数据吗？", function(r) {
				if (r) {
					$.post("${basePath}typeconnection/del.do", {
						id:id
					}, function(result) {
						if (result.success) {
